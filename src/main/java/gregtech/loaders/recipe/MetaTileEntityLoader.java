...
public class MetaTileEntityLoader {
    ...
    public static void init() {
        ...
        // Super / Quantum Tanks
        ModHandler.addShapedRecipe(true, "super_tank_ulv", MetaTileEntities.QUANTUM_TANK[10].getStackForm(), "CPC", "PHP", "CFC", 'C', new UnificationEntry(OrePrefix.circuit, Tier.ULV), 'P', new UnificationEntry(OrePrefix.plate, Materials.Steel), 'F', MetaItems.ELECTRIC_PUMP_LV.getStackForm(), 'H', MetaTileEntities.BRONZE_DRUM.getStackForm());
