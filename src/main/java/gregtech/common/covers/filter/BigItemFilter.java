...
public class BigItemFilter extends ItemFilter {

    private static final int MAX_MATCH_SLOTS = 9 * 4;
    ...
    public void initUI(Consumer<Widget> widgetGroup) {
        ...
        for (int i = 0; i < MAX_MATCH_SLOTS; i++) {
            widgetGroup.accept(new PhantomSlotWidget(itemFilterSlots, i, 10 + 18 * (i % COLUMN), 18 * (i / ROW)).setBackgroundTexture(GuiTextures.SLOT));
        }
